...
export class SelectMenuComponent implements OnInit {
  ...
  toggleMenu() {
    ...
    const menuContainer = this.menuOptions.nativeElement as HTMLElement;
    setTimeout(() => {
      const activeItem = menuContainer.querySelector('.active') as HTMLElement;
      if (activeItem) {
        const top = activeItem.offsetTop - menuContainer.offsetTop;
